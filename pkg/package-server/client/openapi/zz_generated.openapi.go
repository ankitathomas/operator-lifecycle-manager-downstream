...
func schema_api_pkg_operators_v1alpha1_APIServiceDescription(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/operator-framework/api/pkg/operators/v1alpha1.APIResourceReference", "./scripts/olm/../../staging/api/pkg/operators/v1alpha1.ActionDescriptor", "./scripts/olm/../../staging/api/pkg/operators/v1alpha1.SpecDescriptor", "./scripts/olm/../../staging/api/pkg/operators/v1alpha1.StatusDescriptor"},
	}
}
